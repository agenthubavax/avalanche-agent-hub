---
title: Why Avalanche Needs an Agent SDK — And Why We Built One
published: true
description: The AI agent revolution is here. Avalanche has the infrastructure. But where are the developer tools? We built agent-hub-avax to fill that gap.
tags: avalanche, web3, typescript, aiagents, opensource
canonical_url: https://agenthubavax.github.io/avalanche-agent-hub/blog/why-avalanche-needs-agent-sdk
---
